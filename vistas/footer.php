    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="www.iess.com">IESSC - Planificación</a>.</strong> All rights reserved.
    </footer>
    <!-- jQuery 2.1.4 -->
    ...
    <script type="text/javascript" src="../public/datatables/vfd_fonts.js"></script>
